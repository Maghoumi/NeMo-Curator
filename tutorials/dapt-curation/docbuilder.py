...
class DAPTtxtDownloader(DocumentDownloader):
    ...
    def download(self, url: str) -> str:
        ...
        if os.path.exists(output_file):
            print(
                f"Wikipedia article '{output_file}' already exists, skipping download."
            )
            return output_file

        print(f"Downloading Wikipedia article '{url}'...")
...
class GitHubDownloader(DocumentDownloader):
    ...
    def download(self, url: str) -> str:
        ...
        for branch in ["master", "main"]:
            ...
            print(f"Downloading GitHub repository '{zip_url}'...")
